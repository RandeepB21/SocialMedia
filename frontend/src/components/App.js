    ...
    <div className="fill-parent">
      <BrowserRouter>
        <Navbar collapseOnSelect expand="md" bg="dark" variant="dark">
          ...
          <Container fluid>
            <LinkContainer to="/">
              <Navbar.Brand>Social Media Clone</Navbar.Brand>
            </LinkContainer> 
            <Navbar.Toggle />
            <Navbar.Collapse>
              ...
              <Nav>
                ...
                <Navbar.Text>
                  ...
                  <Button type="button" variant="primary" onClick={() => {setUser(""); setAlert({variant: "warning", message: "Signed Out Successfully"})}}>
                    Logout
                  </Button>
                </Navbar.Text>
                ) 
